#!/usr/bin/env bash
# run_all.sh — Run all mysql-lab exercise tests
...
echo ""
echo "${BOLD}=========================================${RESET}"
echo "${BOLD}  mysql-lab — Automated Test Suite${RESET}"
echo "${BOLD}=========================================${RESET}"
echo ""
...
log_info "Checking MySQL is ready..."
assert "MySQL is running" ssh_vm "systemctl is-active mysql"
